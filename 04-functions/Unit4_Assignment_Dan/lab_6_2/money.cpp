...
//	          to dollars and cents which is stored in a local variable
// called 	          total which is sent back to the calling function
// through the 	          parameter dollars. It will keep a running total of all
// the money 	          processed in a local static variable called sum.
//
