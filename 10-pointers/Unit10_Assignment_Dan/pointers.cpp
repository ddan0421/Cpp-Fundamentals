...
int main() {
  ...
  area = *lengthPtr * *widthPtr; // Fill in code to find the area by using only
                                 // the pointer variables

  cout << "The area is " << area << endl;

  if (*lengthPtr > *widthPtr) // Fill in the condition length > width by using
                              // only the pointer variables)
    cout << "The length is greater than the width" << endl;

  else if (*widthPtr > *lengthPtr) // Fill in the condition of width > length by
                                   // using only the pointer variables)
