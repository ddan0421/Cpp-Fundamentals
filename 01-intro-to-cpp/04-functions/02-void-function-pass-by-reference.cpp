...
int main() {
  ...
  /*
   * The actual parameter grossPay is paired with
   * gross since they both are the third parameter in their respective lists.
   * But since this pairing is pass by reference, these two names refer to the
   * SAME memory location. Thus what the function does to its formal parameter
   * gross changes the value of grossPay. After the calPaycheck function finds
   * gross, control goes back to the main function that has this value in
   * grossPay. main proceeds to find the net pay, by taking 20% off the gross
   * pay, and printing it.
   */
