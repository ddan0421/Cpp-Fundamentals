...
#### Dynamic array-based list (growable)
...
#### `std::vector` is an array-based list
...
#### Simpler intro example (head + tail, append, prepend, search, insert-after, remove-after, traverse, print, insertion sort)
...
#### Simpler intro example (head + tail, append, prepend, search, insert-after, remove, traverse, move-after, insertion sort)
...
#### Doubly-linked list with a dummy head node
