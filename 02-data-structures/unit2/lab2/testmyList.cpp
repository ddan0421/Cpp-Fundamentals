...
int main() {
  ...
  std::cout << "\nInvalid insert tests (list should remain unchanged if "
               "handled safely)\n";
  l3.insert(123, -1);
  l3.insert(123, 100);
  std::cout << "Expected: 1 2 99 3 4 5 6\n";
  ...
  l4.append(100);
  std::cout
      << "After changing original l4, assigned l5 should stay unchanged.\n";
  ...
  std::cout << "Expected results: 0 0 | Actual: " << badRemove1 << " "
            << badRemove2 << '\n';
