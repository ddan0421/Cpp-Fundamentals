...
bool test1(std::ostream &testFeedback) {
  GroceryListTest test({"add carrots",
                        "verify carrots",
...
bool test2(std::ostream &testFeedback) {
  GroceryListTest test(
      {"add chips", "add cookies", "add waffles", "add syrup", "add ice cream",
       "add lettuce", "verify chips,cookies,waffles,syrup,ice cream,lettuce",
