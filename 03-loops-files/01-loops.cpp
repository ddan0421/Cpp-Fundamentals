...
int main(){
  ...
  // mode the comparison between age and 49 is made first. Then the value of age is 
  // incremented by one.
  //
  // Things are much different if we replace the posfix operator with the prefix operator:
  //
  if (++age > 49)
    cout << "Congratulations - You have made it to the half-century"
         << " mark !" << endl;
